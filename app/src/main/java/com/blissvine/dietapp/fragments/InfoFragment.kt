      ...
      btnBmiCalculate.setOnClickListener {
               when{
                   (!checkBoxMale.isChecked) && (!checkBoxFemale.isChecked) -> {
                       ...
                       Toast.makeText(requireContext(), "Please enter height value", Toast.LENGTH_SHORT).show()
                   }
                   weightValue.isNullOrEmpty() -> {
                       Toast.makeText(requireContext(), "Please enter weight value", Toast.LENGTH_SHORT).show()
                   } else ->{

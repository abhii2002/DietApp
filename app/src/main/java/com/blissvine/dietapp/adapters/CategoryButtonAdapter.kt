...
import kotlinx.android.synthetic.main.dietplan_category_button_item.view.*
...
class CategoryButtonAdapter(private val categoriesList: List<CategoryButtonModel>) : RecyclerView.Adapter<CategoryButtonAdapter.ViewHolder>()
    {
        ...
        override fun onCreateViewHolder(
            ...
            val view = LayoutInflater.from(parent.context).inflate(R.layout.dietplan_category_button_item, parent, false)
        ...
        override fun onBindViewHolder(holder: CategoryButtonAdapter.ViewHolder, position: Int) {
            ...
            if (position == oldposition) {
                holder.buttonCategory.background = holder.view.context.getDrawable(R.drawable.diet_plan_menu_button_bg_selected)
                ...
                holder.buttonCategory.background = holder.view.context.getDrawable(R.drawable.diet_plan_menu_button_bg)

...
import kotlinx.android.synthetic.main.horizontal_recyclerview_item.view.*



class HorizontalItemAdapter(
    private val dishes: List<Model>): RecyclerView.Adapter<HorizontalItemAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
       val view = LayoutInflater.from(parent.context).inflate(R.layout.horizontal_recyclerview_item, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(position % 2 == 0){
             holder.llHorizontalRecyclerViewItem.background = ContextCompat.getDrawable(holder.view.context,

...
import com.blissvine.dietapp.activities.DishesDescriptionActivity
import com.blissvine.dietapp.models.IngredientsImageModel
...
class VerticalItemAdapter(private val dishes: List<VerticalRvModel>,
  ...
  class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(position % 2 ==0){
            holder.verticalRecyclerView_imageBg.background = ContextCompat.getDrawable(holder.view.context,
